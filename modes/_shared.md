...
**Each mode declares its own file load list at the top of its mode file. Only load what that mode specifies.**

**RULE: NEVER hardcode metrics from proof points.** Read them from cv.md + article-digest.md at evaluation time.
**RULE: For article/project metrics, article-digest.md takes precedence over cv.md.**
**RULE: Read _profile.md AFTER _shared.md. User customizations in _profile.md override defaults here.**
...
| Read | Files declared in each mode's load list |
